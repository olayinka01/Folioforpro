...
<link rel="stylesheet" href="{{URL::asset('css/cropiback.css')}}" type="text/css" media="all">
<link rel="stylesheet" href="{{URL::asset('css/cropiphoto.css')}}" type="text/css" media="all">
<link rel="stylesheet" href="{{URL::asset('css/cropiwork.css')}}" type="text/css" media="all">
<link rel="stylesheet" href="{{URL::asset('css/layout-shop.css')}}" type="text/css" media="all">
...
@yield('body')
	...
	<script type="text/javascript" src="{{URL::asset('js/scriptc.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('js/scriptc2.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('js/scriptc3.js')}}"></script>
